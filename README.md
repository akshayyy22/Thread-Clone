<div align="center">
  <br />
    <a href="https://github.com/akshayyy22/Thread-Clone.git" target="_blank">
      <img src="./Threads-Clone-Assets/banner.png" alt="Project Banner">
    </a>
  <br />
...
- **Authentication**: Secure email, password, and social logins (Google and GitHub) with robust profile management.
- **Engaging Home Page**: A visually captivating home page featuring the latest threads for an immersive user experience.

- **Thread Creation**: Seamlessly create threads to encourage community participation.

- **Dynamic Commenting**: Foster discussions within threads with a dynamic commenting feature.

- **Nested Threads**: Structured conversation flow with nested thread support.

- **User Search & Pagination**: Explore users effortlessly with a searchable and paginated user directory.

- **Activity Notifications**: Stay informed with activity notifications for thread interactions.

- **Customizable Profiles**: Personalize profile settings and information display.

- **Community Creation & Invitations**: Create communities and invite members with customizable email templates.

- **Community Member Management**: Manage community members efficiently with role changes and removals.

- **Admin-Specific Threads**: Admins can create threads tailored to their community.

- **Community Search & Pagination**: Discover communities easily with a searchable and paginated directory.

- **Community Profiles**: Explore community profiles with thread and member overviews.

- **Pixel-Perfect Design**: Transform Figma designs into pixel-perfect, responsive layouts.

- **Blazing-Fast Performance**: Enjoy optimal performance and instantaneous page transitions.

- **Server-Side Rendering**: Utilize Next.js for enhanced performance and SEO benefits.

- **MongoDB Integration**: Manage complex schemas and data populations seamlessly with MongoDB.

- **Seamless File Uploads**: Share media effortlessly with UploadThing integration.

- **Real-Time Updates**: Keep users informed with real-time event listening through webhooks.

- **Robust Security Measures**: Ensure application security with middleware, API actions, and authorization.

- **Efficient Routing**: Utilize Next.js layout route groups for streamlined routing.

- **Data Integrity**: Ensure data integrity with Zod data validation.

- **Streamlined Form Management**: Manage forms efficiently with React Hook Form.

...and much more, including scalable code architecture and reusability.
...
```bash
git clone https://github.com/akshayyy22/Thread-Clone.git
cd Thread-clone
```
...
Assets used in the project are [here](https://drive.google.com/drive/folders/1QqFJp_nAQFkrSHSvHIIhMl-rnMHR1KA-?usp=sharing)

## Screenshots

![Screenshot](./Threads-Clone-Assets/1.png)
![Screenshot](./Threads-Clone-Assets/2.png)
![Screenshot](./Threads-Clone-Assets/3.png)
![Screenshot](./Threads-Clone-Assets/4.png)
![Screenshot](./Threads-Clone-Assets/5.png)
![Screenshot](./Threads-Clone-Assets/6.png)
![Screenshot](./Threads-Clone-Assets/7.png)
